    ...
    container.innerHTML = `
        <div class="w-full md:w-10/12 lg:w-8/12 mx-auto">
            <div class="mb-4 rounded-xl overflow-hidden">
                <div class="accordion__title active [&.active+div]:bg-black [&.active+div]:text-white relative cursor-pointer bg-gray-100 transition-colors duration-500 relative font-bold text-black text-lg  px-6 py-6 pr-14  after:w-0 after:h-0 after:border-8 after:border-b-0 after:border-transparent after:border-t-black after:block after:absolute after:right-6 after:top-1/2 after:-translate-y-1/2 after:transition-[transform] after:duration-500 [&.active]:bg-black [&.active]:text-white [&.active]:after:border-t-white [&.active]:after:rotate-180">
                    Et quasi architecto
                </div>
                <div class="accordion__content h-0 overflow-hidden transition-[height] duration-500">
                    <div class="p-6">
            ...
            <div class="mb-4 rounded-xl overflow-hidden">
                <div class="accordion__title relative cursor-pointer [&.active+div]:bg-black [&.active+div]:text-white   bg-gray-100 transition-colors duration-500 relative font-bold text-black text-lg  px-6 py-6 pr-14 after:w-0 after:h-0 after:border-8 after:border-b-0 after:border-transparent after:border-t-black after:block after:absolute after:right-6 after:top-1/2 after:-translate-y-1/2 after:transition-[transform] after:duration-500 [&.active]:bg-black [&.active]:text-white [&.active]:after:border-t-white [&.active]:after:rotate-180">
                    Et quasi architecto
                </div>
                <div class="accordion__content h-0 overflow-hidden transition-[height] duration-500">
                    <div class="p-6">
